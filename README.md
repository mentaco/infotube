...
テキストファイルの内容を循環表示するだけでなく、外部コマンドの通知やWebAPIから取得した情報も表示できます。

![screen_capture](https://github.com/user-attachments/assets/27063bee-6327-48fa-a1c8-ad4d020016c2)
...
*   **WebAPI連携**:
    *   設定したAPIを定期的にポーリングし、最新情報を割り込み表示します。
...
```bash
git clone https://github.com/mentaco/infotube.git
cd infotube
cargo install --path .
```
